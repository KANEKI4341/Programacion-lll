...
///Al finalizar, pregunta al usuario si desea "Listar contactos". Si dice que sí, lee el archivo, haz un 
///Split(';') y muestra los datos en una tabla limpia en la consola.

using Gestor_de_Contactos_Simple.Clases;
using System;
